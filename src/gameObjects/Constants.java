...
public class Constants {
	...
	/**
	 * PROPIEDADES DE LAS naves ENEMIGAS(OVNIS)
	 * */
  ...
  /**
   * PROPIEDADES DEL MENU Y ESTADO DE CARGA
   */
	...
	public static final String SCORE_PATH = FileSystemView.getFileSystemView().getDefaultDirectory().getPath() +
			"\\Space_Ship_Game\\data.json"; // data.xml si usas XMLParser

	/**
	 * ESTAS VARIABLES SON REQUERIDAS SI USAS XMLParser
	 * */
	public static final String PLAYER = "PLAYER";
	public static final String PLAYERS = "PLAYERS";

	/** =============================================
	 * PROPIEDADES DE LOS POWER UP
	 * */
